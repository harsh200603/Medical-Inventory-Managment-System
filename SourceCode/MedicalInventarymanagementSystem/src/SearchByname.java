...
public class SearchByname implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==b2)
			...
			JOptionPane.showMessageDialog(f1, "Pls Enter Name");
		else
		try
		  {
			DAO db=new DAO();
			...
			String selectQuery = "select * from record where medicinename=?";
			...
			{	   System.out.println("No Recored Found with Name= !!!"+s1);
			       JOptionPane.showMessageDialog(f1,"Name Not Found");
			}
